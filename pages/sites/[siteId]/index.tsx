...
// Add fallback for missing site systems  
...
const SitePage: NextPage = () => {
  ...
  // Convert siteId to display name  
  const siteName = siteId === 'exowatt-ranch' ? 'Exowatt Ranch' :  
                 siteId === 'demo-site' ? 'Demo Site' :  
                 String(siteId);  
  
  // Get systems data for this site with fallback  
  const siteSystemsData = getSiteSystemsData(String(siteId));
